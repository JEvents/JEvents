...
rsync -av --progress ../ ./ --exclude build --exclude '.gitignore' --exclude '.DS_Store' --exclude '._.DS_Store' --exclude 'jevcustom.css' --exclude '*.css.map' --exclude 'gslframework*' --no-links
