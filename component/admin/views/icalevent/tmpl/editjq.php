...
?>
		...
		<div class="adminform form-horizontal" >
			...
			if (!$cfg->get('com_single_pane_edit', 0))
			{
				...
				<?php
				// Tabs
				echo JevHtmlBootstrap::startPane( 'myEditTabs', array('active' => 'common'));
				echo JevHtmlBootstrap::addPanel( 'myEditTabs', "common");
			}
			?>
			...
			if (!$cfg->get('com_single_pane_edit', 0) && !$cfg->get('timebeforedescription', 0))
			{
				...
				echo JevHtmlBootstrap::addPanel( "myEditTabs", "calendar");
			}
			if (!$cfg->get('timebeforedescription', 0))
			{
				ob_start();
