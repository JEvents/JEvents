...
if (!$cfg->get('com_single_pane_edit', 0)) {
 ...
 ?>
    ...
    <table cellpadding="5" cellspacing="2" border="0"  class="adminform" id="jevadminform">
		...
		<?php
		$filter_state_options[] = JHTML::_('select.option', 1, JText::_('JEV_PUBLISHED'));
		$filter_state_options[] = JHTML::_('select.option', 0, JText::_('JEV_UNPUBLISHED'));
		echo  JHTML::_('select.genericlist', $filter_state_options, 'filter_state', '', 'value', 'text', $this->row->published);
		?>
