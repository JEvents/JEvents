...
document.addEventListener('DOMContentLoaded', function () {
	...
	// Highlight client download button when no sites are available
	/*
	let sites  = document.querySelectorAll("#siteList tbody tr");
	let filterVisible = document.querySelector(".js-stools-container-filters-visible");
	if (sites.length == 0 && !filterVisible && document.getElementById('filter_search').value == "")
	{
		document.getElementById('ysjoomla_wrapper').querySelector('.sitesclientpackage').parentNode.classList.add('yellowhighlight');
		document.getElementById('ysjoomla_wrapper').classList.add('yellowhighlightdropdown');

		document.getElementById('yswp_wrapper').querySelector('.sitesclientpackage').parentNode.classList.add('yellowhighlight');
		document.getElementById('yswp_wrapper').classList.add('yellowhighlightdropdown');
	}
	*/
	let totalSites  = document.getElementById("totalsites");
	if (totalSites && totalSites.value == 0) {
		// need try catch since some of these may not be there
		try {
			document.querySelector('.sitesclientpackage').parentNode.classList.add('yellowhighlight');
		}
		catch (e) {
