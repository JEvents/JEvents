...
/**
 * Admin-specific event query model; extends the site DBModel with backend queries.
 * Legacy class name: JEventsAdminDBModel
 */
class AdminDBModel extends \JEventsDBModel
{

	/**
	 * Gets raw vevent row (not a repeat), usually for editing purposes.
	 *
	 * @param int $agid vevent id
	 *
	 * @return stdClass|null details of vevent selected
	 */
	...
	/**
	 * Get all native JEvents iCal calendars (not imported from URL or file).
	 */
