...
function DefaultViewHelperFooter16($view)
{
	...
	{ ?>
		<div class="ev_noprint"><p align="center">
				<a href="#close"
				   onclick="if (window.parent==window){self.close();} else {try {window.parent.closeJevModalBySelector('#myEditModal');}catch (e){}try {window.parent.SqueezeBox.close(); return false;} catch(e) {self.close();return false;}}"
