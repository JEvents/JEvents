...
function DefaultExportGoogle($view, $publiclink, $privatelink)
{
	...
	<div class='ical_form_button export_public'>
		<a href='http://www.google.com/calendar/render?cid=<?php echo  urlencode(str_replace(array(' http://','https://'), array('webcal://', 'webcal://'), $publiclink));?>' target='_blank' rel='nofollow'>
