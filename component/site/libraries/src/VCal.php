...
/**
 * Represents a single VEVENT block for vCalendar export.
 * Legacy class name: vEvent
 */
class VEvent
{
	var $properties;
...
/**
 * Builds a VCALENDAR export from legacy JEvents 1.x event objects.
 * Legacy class name: vCal
 */
class VCal
{
	var $properties;
