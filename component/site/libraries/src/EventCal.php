...
// TODO: migrate body from component/site/libraries/jeventcal.php
if (!class_exists('jEventCal', false))
{
	require_once \JEV_PATH . 'libraries/jeventcal.php';
}

\class_alias('jEventCal', __NAMESPACE__ . '\\EventCal');
