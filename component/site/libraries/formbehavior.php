...
abstract class JevHtmlFormbehavior
{
	...
	public static function chosen($selector = '.advancedSelect', $debug = null, $options = array())
	{
		...
		JFactory::getDocument()->addScript("/components/com_jevents/assets/js/chosen.jquery.js");
		JFactory::getDocument()->addStylesheet("/components/com_jevents/assets/css/chosen.css");
