...
$changelog[$extension][$version]["features"][]      = "List views can now be configured to only show first repeat - useful for series of events that a user signs up for but can only sign up for the first one";
...
$changelog[$extension][$version]["bugfixes"][]      = "fix for next/prev event links on menu items with category restrictions";
