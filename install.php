	...
	public function preflight ($type, $parent) {
		...
		if (!$is_enabled){
			...
			if (version_compare(JVERSION, '3.0', '<')){
				Jerror::raiseWarning(null, 'This version of JEvents is desgined for Joomla 3.4.1 and later.<br/>Please update Joomla before upgrading JEvents to this version' );
				return false;
			}
			return;
		}
