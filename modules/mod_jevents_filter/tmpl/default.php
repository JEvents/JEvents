...
if (JRequest::getCmd("task") == "icalrepeat.detail" && $params->get('showindetails', 0) == 0  || JRequest::getCmd("task") == "icalevent.edit" || JRequest::getCmd("task") == "icalevent.detail" || JRequest::getCmd("task") == "icalrepeat.edit")
{
	return;
}
