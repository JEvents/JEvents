...
class ZimModCalView
{
	...
	function ZimModCalView($params, $modid){
	...
	function _displayCalendarMod($time, $startday, $linkString, $day_name, $monthMustHaveEvent=false, $basedate=false){
		...
		$view =  $this->getTheme();
		$viewpath = JURI::root() . "components/$compname/views/".$view."/assets";
		...
		if( $this->minical_showlink ){
			...
			$content .= "\n".'<table cellpadding="0" cellspacing="0" align="center" class="mod_events_monthyear" style="width:'. $width .';">' . "\n"
			. '<tr class="mod_events_header_tr">' . "\n";
			...
			if( $this->minical_showlink == 1 ){
				...
				//}
				//".JText::_('JEV_NEXT_LINK')."<img src='".$viewimages."/Right.png' alt='".JText::_('JEV_NEXT_LINK')."'>

				if( $this->minical_prevmonth ){
					$content .= $this->monthYearNavigation($basefirst_of_month,"-1 month",'<img src="'.$viewimages.'/Left_white_arrow.png" alt="' . JText::_("JEV_PREV_LINK") . '"><span class="mod_prev">' . JText::_("JEV_PREV_LINK").'</span>' ,JText::_('JEV_CLICK_TOSWITCH_PM'));
				}
				...
				if( $this->minical_nextmonth ){
					$content .= $this->monthYearNavigation($basefirst_of_month,"+1 month",'<span class="mod_prev">' . JText::_("JEV_NEXT_LINK").'</span><img src="'.$viewimages.'/Right_white_arrow.png" alt="' . JText::_("JEV_NEXT_LINK") . '">',JText::_('JEV_CLICK_TOSWITCH_NM'));					
				}
		...
		$content	.= '<table align="center" class="mod_events_table" cellspacing="0" cellpadding="2" style="width:'.$width.';height:'.$height.';">'.$lf
	...
	function getCal($modid=0) {
		...
		$day_name[0] = '<span class="mini_cal_sunday">' .   $day_name[0] . '</span>';
		$day_name[6] = '<span class="mini_cal_saturday">' . $day_name[6] . '</span>';
